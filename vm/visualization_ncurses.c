...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   visualization_ncurses.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: crath <crath@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/07 18:14:29 by crath             #+#    #+#             */
/*   Updated: 2019/09/25 20:21:07 by crath            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			draw_carries(t_vm *vm)
{
	t_list	*tmp;
	int		i;
	int		j;
...
static void			print_row(t_vm *vm, int *j, int n, int *i)
{
